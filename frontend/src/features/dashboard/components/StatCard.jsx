...
export default function StatCard({ item }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-100 dark:border-slate-800/80 shadow-xs hover:shadow-md transition-all duration-200 flex items-center gap-4">
      {/* Icon */}
      ...
      <div className="space-y-1">
        ...
        <div className={`flex items-center gap-1 text-[11px] font-semibold ${theme.trendColor}`}>
