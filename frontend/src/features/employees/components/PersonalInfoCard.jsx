...
import { User, Mail, Phone, Calendar, CircleDot, MapPin, Edit3 } from 'lucide-react';
        ...
        {fields.map((field, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400 w-32 shrink-0">
